...
CFLAGS   = -Wundef -Wall -Wno-switch -Wno-parentheses -Wpointer-arith -Wredundant-decls -Wmissing-prototypes -Wdisabled-optimization -Wno-pointer-sign -Wdeclaration-after-statement -std=gnu99  -O3 -mcpu=750 -meabi -mrvl -msdata -mmultiple -mstring -pipe -g -ffast-math -frename-registers -DGEKKO -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE64_SOURCE -Ilibdvdread4 -I$(DEVKITPRO)/portlibs/ppc/include -I$(DEVKITPRO)/libogc/include -I. -Iffmpeg  -DFF_API_MAX_STREAMS=0
CXXFLAGS = -Wundef -Wall -Wno-switch -Wno-parentheses -Wpointer-arith -Wredundant-decls  -O3 -mcpu=750 -meabi -mrvl -msdata -mmultiple -mstring -pipe -g -ffast-math -frename-registers -DGEKKO -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE64_SOURCE -D__STDC_CONSTANT_MACROS -D__STDC_LIMIT_MACROS -Ilibdvdread4 -I$(DEVKITPRO)/portlibs/ppc/include -I$(DEVKITPRO)/libogc/include -I. -Iffmpeg  -DFF_API_MAX_STREAMS=0
CC_DEPFLAGS = -MD -MP -O3 -mcpu=750 -meabi -mrvl -msdata -mmultiple -mstring -pipe -g -ffast-math -frename-registers
...
EXTRALIBS          = -mrvl -ffast-math   -lfreetype -liconv -lfribidi -lz -laesnd -lwiikeyboard -ldi -ltinysmb -lwiiuse -lbte -lfat -lntfs -lext2fs -logc -static -L$(DEVKITPRO)/libogc/lib/wii -L$(DEVKITPRO)/portlibs/ppc/lib  -lm
...
ASFLAGS    = $(CFLAGS)
AS_DEPFLAGS= -MD -MP -O3 -mcpu=750 -meabi -mrvl -msdata -mmultiple -mstring -pipe -g -ffast-math -frename-registers
HOSTCC     = $(HOST_CC)
